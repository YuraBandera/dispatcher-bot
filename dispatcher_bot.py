...
2. Точне місце події (конкретна ігрова адреса, сектор або чіткий орієнтир).
3. Наявність та кількість постраждалих, а також стан заявника.
...
- Не припиняй опитування, поки не отримаєш чіткі дані по кожному з 3-х пунктів.
